...
abstract class AbstractApiController implements ServiceSubscriberInterface
{
    ...
    use ServiceMethodsSubscriberTrait, EntityManagerProviderTrait, FormFactoryInterfaceProviderTrait, CustomJmsSerializerProviderTrait, RequestStackProviderTrait;
...
//    public function getListAPIService(): ListAPIFilterService
//    {
//        return $this->container->get(ListAPIFilterService::class);
//    }
...
//    }
    ...
    {
        return $this->getRequestStack()->getCurrentRequest()->query->all();
    }
     ...
     * @throws NotFoundExceptionInterface
     */
    public function listApiParams(): array
    {
